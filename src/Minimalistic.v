...
Section LateInterp.
  ...
  Section OTP.
    ...
    Global Instance Proper_map eta: Proper (pointwise_relation (PositiveMap.t (interp_base_type rand eta)) (comp_spec eq) ==> Comp_eq) (Bind (ret PositiveMap.empty (interp_type rand eta))).
