...
Section Models.
  ...
  (* Finite bound on the number of random values you and the attacker
     will need. *)
  ...
  Section SymbolicModel.
    ...
    | Indist : forall (l1 l2 : list SymbolicSort) (H: length l1 = length l2),
        SymbolicPredicate (l1 ++ l2).
  ...
  Section CompInterp.
    ...
    Definition constant_messagecomp (m : message) : MessageComp :=
      mkMessageComp (fun _ _ _ => Ret message_eq_dec m)
    ...
    Definition if_then_else_messagecomp (b : BoolComp) (m1 m2 : MessageComp) :
      MessageComp :=
      mkMessageComp (if_then_else_comp _ _ _)
    ...
    Definition eq_boolcomp (m1 m2 : MessageComp) : BoolComp :=
      mkBoolComp (eq_comp _ _) (eq_poly m1 m2).
    ...
    Definition eql_boolcomp (m1 m2 : MessageComp) : BoolComp :=
      mkBoolComp (eql_comp _ _) (eql_poly m1 m2).
